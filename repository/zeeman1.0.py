    ...
    def run(self):
        ...
        #刷新时间轴防止报错
            ...
            if self.parameter==2:
                ...
                # self.urukul0_ch0.set_att(self.Preparation_Attenuation*dB)#设置729态制备功率
                # self.urukul0_ch1.set_att(self.Zeeman_Attenuation*dB)#设置729扫Zeeman功率
                ...
                while self.Zeeman_Frequency<self.Zeeman_Frequency_End:
                    ...
                    for i in range(1):
                        ...
                        t_end=self.ttl1.gate_rising(15*ms)#从当前时刻开始记录上升沿，直到括号内的时间为止。
                        ...
                        if t_edge>0:#如果探测到触发信号的上
                            ...
                            self.ttl0.on()#打开397Double Pass的AOM
                            ...
                            self.ttl2.off()#将三维冷却的397光打开
                            self.ttl4.off()#将z方向的397光打开
                            self.ttl5.off()
                            self.ttl11.off()
                            self.ttl12.off()
                            #态探测
